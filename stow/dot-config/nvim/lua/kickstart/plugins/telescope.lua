...
return {
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- https://www.reddit.com/r/neovim/comments/oeesw5/comment/h45u7pc

      local search_folder = function(cmd)
        require('telescope.pickers')
          .new({}, {
            ...
            attach_mappings = function(prompt_bufnr)
              require('telescope.actions.set').select:replace(function(_, _)
